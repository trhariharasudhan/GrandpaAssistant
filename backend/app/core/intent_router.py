...
from modules.browser_automation_module import (
    ...
    extract_entities_from_selected_text,
...
from modules.messaging_automation_module import (
    ...
    preview_email_draft,
    preview_whatsapp_message,
    relationship_email_shortcut,
    relationship_whatsapp_message,
...
from modules.window_context_module import (
    ...
    open_numbered_result_and_summarize,
    open_first_result_and_summarize,
    open_browser_result,
    open_result_and_copy_title,
    open_result_in_new_tab,
    open_selected_link_in_new_tab,
    search_page_and_click_first_match,
    summarize_browser_selection,
...
COMMAND_REGISTRY = [
    ...
    {
        "intent": "agenda.focus",
        "patterns": ["what should i do now", "what should i focus on", "what is my focus", "what now", "focus suggestion"],
        "type": "exact",
    ...
    {
        "intent": "messaging.whatsapp.preview",
        "patterns": ["preview whatsapp message to", "preview message to"],
        "type": "startswith",
        "handler": preview_whatsapp_message,
        "category": "messaging_automation",
        "confidence": 0.95,
    },
    {
        "intent": "messaging.whatsapp.quick_shortcut",
        "patterns": ["message ", "whatsapp "],
        "type": "startswith",
        "handler": quick_whatsapp_message,
        "category": "messaging_automation",
        "confidence": 0.96,
    },
    {
        "intent": "messaging.whatsapp.relationship_shortcut",
        "patterns": ["message my", "whatsapp my", "message emergency contact", "whatsapp emergency contact"],
        "type": "startswith",
        "handler": relationship_whatsapp_message,
        "category": "messaging_automation",
        "confidence": 0.95,
    },
    {
    ...
    },
    {
        ...
        "type": "startswith",
        "handler": relationship_email_shortcut,
        "category": "messaging_automation",
        "confidence": 0.95,
    },
    {
        "intent": "messaging.gmail.preview",
        "patterns": ["preview mail to", "preview email to"],
        "type": "startswith",
        "handler": preview_email_draft,
        "category": "messaging_automation",
        "confidence": 0.95,
    },
    {
    ...
    {
        "intent": "app.browser.result_by_number_summary",
        "patterns": ["open result "],
        "type": "startswith",
        "handler": open_numbered_result_and_summarize,
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.result_by_number_new_tab",
        "patterns": ["open result "],
        "type": "startswith",
        "handler": open_result_in_new_tab,
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.result_copy_title",
        "patterns": ["open result "],
        "type": "startswith",
        "handler": open_result_and_copy_title,
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.result_by_number",
        "patterns": ["open result "],
        "type": "startswith",
        "handler": open_browser_result,
        "category": "app_intelligence",
    ...
    {
        "intent": "app.browser.selection_summary",
        "patterns": [
            "summarize browser selection",
            "summarize selected browser text",
            "read browser selection",
        ],
        "type": "exact",
        "handler": lambda command: summarize_browser_selection(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
    ...
    {
        "intent": "app.browser.selection_read_aloud",
        "patterns": [
            "read selected text aloud",
            "read selected browser text aloud",
            "speak selected browser text",
        ],
        "type": "exact",
        "handler": lambda command: read_selected_browser_text_aloud(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_save_note",
        "patterns": [
            "save selected text as note",
            "save selected browser text as note",
            "add selected text to notes",
        ],
        "type": "exact",
        "handler": lambda command: save_selected_browser_text_as_note(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_reminder",
        "patterns": [
        ...
        "type": "startswith",
        "handler": create_reminder_from_selected_browser_text,
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_summary_note",
        "patterns": [
            "summarize selected text and save note",
            "save selected text summary as note",
            "summarize browser selection and save note",
        ],
        "type": "exact",
        "handler": lambda command: summarize_selected_text_and_save_note(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
    ...
    },
    {
        ...
        "patterns": [
            ...
            "save selected text explanation as note",
            "explain browser selection and save note",
        ],
        "type": "exact",
    ...
    {
        "intent": "app.browser.selection_entities",
        "patterns": [
            "extract emails from selected text",
            "extract phone numbers from selected text",
            "extract dates from selected text",
            "find emails in selected text",
            "find phone numbers in selected text",
            "find dates in selected text",
        ],
        "type": "exact",
        "handler": extract_entities_from_selected_text,
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_search_summary",
        "patterns": [
            "search selected text and summarize",
            "google selected text and summarize",
            "search browser selection and summarize",
        ],
        "type": "exact",
        "handler": lambda command: search_selected_text_and_summarize(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "browser.research.save",
        "patterns": [
            "save research session",
            "save browser research session",
        ],
        "type": "exact",
        "handler": lambda command: save_research_session(),
        "category": "browser_automation",
        "confidence": 0.94,
    },
    {
        "intent": "browser.research.list",
        "patterns": [
        ...
        "type": "exact",
        "handler": lambda command: list_research_sessions(),
        "category": "browser_automation",
        "confidence": 0.94,
    },
    {
        "intent": "browser.research.recap",
        "patterns": [
            "recap last research session",
            "last research session",
            "research recap",
        ],
        "type": "exact",
        "handler": lambda command: recap_last_research_session(),
        "category": "browser_automation",
        "confidence": 0.94,
    },
    {
        ...
        "type": "exact",
        "handler": lambda command: copy_selected_browser_text(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_search",
        "patterns": [
            "search selected text on google",
            "google selected text",
            "search browser selection on google",
        ],
        "type": "exact",
        "handler": lambda command: search_selected_text_on_google(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selection_search_youtube",
        "patterns": [
            "search selected text on youtube",
            "youtube selected text",
            "search browser selection on youtube",
        ],
        "type": "exact",
        "handler": lambda command: search_selected_text_on_youtube(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
        "intent": "app.browser.selected_link_new_tab",
        "patterns": [
            "open selected link in new tab",
            "open browser selection in new tab",
        ],
        "type": "exact",
        "handler": lambda command: open_selected_link_in_new_tab(),
        "category": "app_intelligence",
        "confidence": 0.95,
    },
    {
    ...
    {
        "intent": "notifications.recap",
        "patterns": ["show recap popup", "daily recap popup", "show daily recap popup", "recap popup"],
        "type": "exact",
        "handler": lambda command: show_recap_popup(),
        "category": "notifications",
        "confidence": 0.96,
    },
    {
    ...
    {
        "intent": "tasks.high_priority",
        "patterns": ["high priority tasks", "show high priority tasks", "important tasks"],
        "type": "exact",
        "handler": lambda command: list_high_priority_tasks(),
        "category": "tasks",
        "confidence": 0.96,
    },
    {
        "intent": "tasks.by_category",
        "patterns": ["tasks in", "tasks for", "work tasks", "study tasks", "personal tasks", "health tasks", "finance tasks", "family tasks"],
        "type": "startswith",
        "handler": list_tasks_by_category,
        "category": "tasks",
        "confidence": 0.94,
    },
    {
