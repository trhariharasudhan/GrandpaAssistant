...
from productivity.event_module import get_due_event_titles
...
def run_contact_morning_routine(command):
    ...
    from automation.messaging_automation_module import relationship_whatsapp_message
    from productivity.task_module import add_contact_reminder
