...
FRONTEND_BROWSER_SCRIPT = os.path.join(PROJECT_ROOT, "scripts", "windows", "start_react_frontend.cmd")
FRONTEND_DESKTOP_SCRIPT = os.path.join(PROJECT_ROOT, "scripts", "windows", "start_react_electron.cmd")
